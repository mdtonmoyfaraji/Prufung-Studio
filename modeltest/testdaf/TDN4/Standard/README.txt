Legen Sie hier die Moduldateien für testdaf TDN4 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/testdaf/TDN4/Zusatzbuch/, und laden
...
modeltest/testdaf/TDN4/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

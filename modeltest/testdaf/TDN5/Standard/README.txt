Legen Sie hier die Moduldateien für testdaf TDN5 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/testdaf/TDN5/Zusatzbuch/, und laden
...
modeltest/testdaf/TDN5/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

Legen Sie hier die Moduldateien für testdaf TDN3 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/testdaf/TDN3/Zusatzbuch/, und laden
...
modeltest/testdaf/TDN3/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

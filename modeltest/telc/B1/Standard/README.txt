Legen Sie hier die Moduldateien für telc B1 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/telc/B1/Zusatzbuch/, und laden
...
modeltest/telc/B1/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

Legen Sie hier die Moduldateien für goethe A1 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/goethe/A1/Zusatzbuch/, und laden
...
modeltest/goethe/A1/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

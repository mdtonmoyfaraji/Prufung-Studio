Legen Sie hier die Moduldateien für goethe C2 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/goethe/C2/Zusatzbuch/, und laden
...
modeltest/goethe/C2/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann

Legen Sie hier die Moduldateien für goethe B2 — Buch "Standard" ab:
  lesen.json
  hoeren.json
  schreiben.json
  sprechen.json
...
neben "Standard" an, z. B. modeltest/goethe/B2/Zusatzbuch/, und laden
...
modeltest/goethe/B2/Zusatzbuch/Teil 2/lesen.json — die App zeigt dann
